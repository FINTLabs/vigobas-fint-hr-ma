...
{
    class StillingskodeFactory
    {
        public static Stillingskode Create(IReadOnlyDictionary<string, IStateValue> values)
        {
            ...
            {
                passiv = Convert.ToBoolean(passivedictVal.Value);
            }
